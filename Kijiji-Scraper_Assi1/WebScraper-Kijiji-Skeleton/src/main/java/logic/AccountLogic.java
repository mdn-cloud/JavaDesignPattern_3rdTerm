...
public class AccountLogic extends GenericLogic<Account,AccountDAL>{
    ...
    public Account createEntity(Map<String, String[]> parameterMap) {
        if (parameterMap.get(DISPLAY_NAME)[0] == null || parameterMap.get(DISPLAY_NAME)[0].isEmpty())
        {throw new  ValidationException("Please enter display name.");
        }
    ...
    Account getAllWithMethodRefrence(String user) {
